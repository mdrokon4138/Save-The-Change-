<?php namespace App\Http\Controllers;
	...
	class AdminWithdrawsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Bank","name"=>"bank_name"];
			$this->col[] = ["label"=>"Number","name"=>"account_number"];
