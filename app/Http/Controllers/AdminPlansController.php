<?php namespace App\Http\Controllers;
	...
	class AdminPlansController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Signup Fee","name"=>"signup_fee"];
			...
			$this->form[] = ['label'=>'Is Active','name'=>'is_active','type'=>'hidden', 'value'=>'1', 'validation'=>'required|integer','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'Trial Period','name'=>'trial_period','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Trial Interval','name'=>'trial_interval','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Invoice Period','name'=>'invoice_period','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Invoice Interval','name'=>'invoice_interval','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Grace Period','name'=>'grace_period','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Grace Interval','name'=>'grace_interval','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Prorate Day','name'=>'prorate_day','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Prorate Period','name'=>'prorate_period','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Prorate Extend Due','name'=>'prorate_extend_due','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Active Subscribers Limit','name'=>'active_subscribers_limit','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
