<?php namespace App\Http\Controllers;
	...
	class AdminSettings21Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    */
		...
		$data = [];
		$data['Setting'] = 'Add Data';

		$old = DB::table('settings')->first();

		return view('setting_add', compact('data', 'old'));
		}
