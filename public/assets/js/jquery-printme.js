...
jQuery.fn.printMe = function(options){
	...
	var settings = $.extend({
		// Defaults options.
		path: ['../compact/css/style_admin.css','../compact/css/style.css','../compact/css/jquery-ui.css','../compact/css/bootstrap-multiselect.css','../cs/font-awesome.min.css','../css/style.css','../compact/css/bootstrap.min.css'],
		title: "",
		head: false,
	}, options );
